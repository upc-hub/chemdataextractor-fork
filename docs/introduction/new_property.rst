...
First, we need all the relevant imports::
    ...
    from ..model import BaseModel, Compound, StringType, ModelType
    from ..model.units import TemperatureModel, LengthModel
    from ..parse import I, join
    from ..doc import Paragraph, Heading
