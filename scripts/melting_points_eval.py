...
from ..doc import Paragraph, Table
from ..parse import ChemicalLabelParser, CompoundParser, MpParser
from ..text import HYPHENS, MINUSES
from ..text.normalize import excess_normalize
