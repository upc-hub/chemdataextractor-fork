...
prefix = (I(u'surface')+I(u'area')|I(u'area')+I(u'of')+I(u'surface')|I(u'surface')+I(u'area')+I(u'of')|I(u'area')+I(u'of')+I(u'surface')+I(u'is')).hide()
...
class Surface_AreaParser(BaseSentenceParser):
    root = new_property
