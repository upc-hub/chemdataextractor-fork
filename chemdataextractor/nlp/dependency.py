...
class _DependencyTagger(BaseTagger):
    ...
    def __init__(self):
        try:
            self._nlp = stanza.Pipeline("en", download_method = 'none', tokenize_pretokenized=True, logging_level="ERROR", device="cpu")
        except Exception as e:
            # Commented to be able to run on my secured GPUs
            '''
